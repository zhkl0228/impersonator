...
object PlatformRegistry {
  ...
  fun findPlatform(): Platform {
    // impersonator only vendors okhttp's jvmMain sources, so the Android platforms are absent.
    // Fail loudly instead of silently falling through to the JVM platform on Dalvik/ART.
